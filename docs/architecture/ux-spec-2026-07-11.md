...
**Status:** v1.3 · 2026-07-11 · Phase A of the orchestrated D0–D2+S4 build
...
│ 2026-07-06 │ Study tutor planning chain ⟨FEAT-3ED2⟩│ study-tutor │ Delivered — merged, PR ⟨link⟩ │ ░ pending ░│ ⌗sq  │
│ 2026-07-06 │ Planning wiring fix ⟨FEAT-DD4F⟩       │ study-tutor │ Delivered — merged, PR ⟨link⟩ │ ░ pending ░│ ⌗sq  │
└────────────┴───────────────────────────────────────┴─────────────┴───────────────────────────────┴────────────┴──────┘
...
│  ⟨FEAT-3ED2⟩ merged, PR ⟨link⟩⌗sq│ │ ✖ gate REJECTED Payments API webhooks  │
│ Planning wiring fix              │ │   ⟨FEAT-9A21⟩ · build-3 [R]            │
│  ⟨FEAT-DD4F⟩ merged, PR ⟨link⟩⌗sq│ │                                        │
└──────────────────────────────────┘ └────────────────────────────────────────┘
...
`(feature_id, bar)`; period query with the F-10b two-list semantics; the `/delivered` page per ux
